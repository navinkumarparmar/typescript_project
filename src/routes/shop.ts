...
router.post('/create', validationMiddleware(Shop),verifytokenmiddlewere.verifytoken,verifytokenmiddlewere.verifyrole(['admin','editor']),ShopController.createShop);
